        ...
        CREATE TABLE IF NOT EXISTS suppliers (
            ...
            INSERT INTO suppliers
            VAlUES ('9', 'PB Knäckebröd AB', 'Lars Peterson', ' Sales Agent', 'Sweden', ' ', ' S-345 67', ' Göteborg',
            ...
            INSERT INTO suppliers
            VAlUES ('11', 'Heli Süßwaren GmbH & Co. KG', 'Petra Winkler', ' Sales Manager', 'Germany', ' ', ' 10785', ' Berlin',
                  ' Tiergartenstraße 5', '(010) 9984510', '', '');
            
            INSERT INTO suppliers
            VAlUES ('12', 'Plutzer Lebensmittelgroßmärkte AG', 'Martin Bein', ' International Marketing Mgr.', 'Germany', ' ', ' 60439', ' Frankfurt',
            ...
            INSERT INTO suppliers
            VAlUES ('17', 'Svensk Sjöföda AB', 'Michael Björn', ' Sales Representative', 'Sweden', ' ', ' S-123 45', ' Stockholm',
                  ' Brovallavägen 231', '08-123 45 67', '', '');
            
            INSERT INTO suppliers
            VAlUES ('18', 'Aux joyeux ecclésiastiques', 'Guylène Nodier', ' Sales Manager', 'France', ' ', ' 75004', ' Paris',
            ...
            INSERT INTO suppliers
            VAlUES ('25', 'Ma Maison', 'Jean-Guy Lauzon', ' Marketing Manager', 'Canada', ' Québec', ' H1J 1C3', ' Montréal',
            ...
            INSERT INTO suppliers
            VAlUES ('28', 'Gai pâturage', 'Eliane Noz', ' Sales Representative', 'France', ' ', ' 74000', ' Annecy',
                  ' Bat. B 3, rue des Alpes', '38.76.98.06', '38.76.98.58', '');
            
            INSERT INTO suppliers
            VAlUES ('29', 'Forêts d''érables', 'Chantal Goulet', ' Accounting Manager', 'Canada', ' Québec', ' J2S 7S8', ' Ste-Hyacinthe',
                ...
                UPDATE products SET fk_id_suppliers = 9 WHERE product_name IN ('Gustaf''s Knäckebröd', 'Tunnbröd');
                
                UPDATE products SET fk_id_suppliers = 10 WHERE product_name IN ('Guaraná Fantástica');
                
                UPDATE products SET fk_id_suppliers = 11 WHERE product_name IN ('NuNuCa Nuß-Nougat-Creme', 'Gumbär Gummibärchen', 'Schoggi Schokolade');
                
                UPDATE products SET fk_id_suppliers = 12 WHERE product_name IN ('Rössle Sauerkraut', 'Thüringer Rostbratwurst', 'Wimmers gute Semmelknödel', 'Rhönbräu Klosterbier', 'Original Frankfurter grüne Soße');
                ...
                UPDATE products SET fk_id_suppliers = 17 WHERE product_name IN ('Inlagd Sill', 'Gravad lax', 'Röd Kaviar');
                
                UPDATE products SET fk_id_suppliers = 18 WHERE product_name IN ('Côte de Blaye', 'Chartreuse verte');
                ...
                UPDATE products SET fk_id_suppliers = 23 WHERE product_name IN ('Maxilaku', 'Valkoinen suklaa', 'Lakkalikööri');
                
                UPDATE products SET fk_id_suppliers = 24 WHERE product_name IN ('Manjimup Dried Apples', 'Filo Mix', 'Perth Pasties');
                
                UPDATE products SET fk_id_suppliers = 25 WHERE product_name IN ('Tourtière', 'Pâté chinois');
                ...
                UPDATE products SET fk_id_suppliers = 29 WHERE product_name IN ('Sirop d''érable', 'Tarte au sucre')
